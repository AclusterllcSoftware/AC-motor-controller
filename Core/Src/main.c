...
/* Private macro -------------------------------------------------------------*/
/* USER CODE BEGIN PM */
// extern uint16_t buf1[500], buf2[500], index, c1, c2;
/* USER CODE END PM */
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, M_CH_C_Pin|RS485_DIR_U2_Pin|RLY_3_Pin|RLY_4_Pin
                          |D1_SCR_GATE_1_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, M_CH_A_Pin|TRIAC_1_Pin|TRIAC_2_Pin|RLY_1_Pin
                          |RLY_2_Pin|D1_SCR_GATE_2_Pin|D2_SCR_GATE_1_Pin|D2_SCR_GATE_2_Pin
                          |M_CH_B_Pin|M_NEG_5V_PWM_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, DOUT_2_Pin|DOUT_1_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(DOUT_4_GPIO_Port, DOUT_4_Pin, GPIO_PIN_SET);

  /*Configure GPIO pins : DINP_2_Pin DINP_3_Pin DINP_4_Pin */
  GPIO_InitStruct.Pin = DINP_2_Pin|DINP_3_Pin|DINP_4_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pins : M_CH_C_Pin RLY_3_Pin RLY_4_Pin */
  GPIO_InitStruct.Pin = M_CH_C_Pin|RLY_3_Pin|RLY_4_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pins : RS485_DIR_U2_Pin D1_SCR_GATE_1_Pin */
  ...
  /*Configure GPIO pins : M_CH_A_Pin M_CH_B_Pin M_NEG_5V_PWM_Pin */
  ...
  /*Configure GPIO pins : FACTORY_RST_Pin DINP_1_Pin */
  GPIO_InitStruct.Pin = FACTORY_RST_Pin|DINP_1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pins : TRIAC_1_Pin TRIAC_2_Pin RLY_1_Pin RLY_2_Pin
                           D1_SCR_GATE_2_Pin D2_SCR_GATE_1_Pin D2_SCR_GATE_2_Pin */
  ...
  /*Configure GPIO pins : DOUT_2_Pin DOUT_1_Pin */
  ...
  /*Configure GPIO pin : DOUT_4_Pin */
  GPIO_InitStruct.Pin = DOUT_4_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_OD;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
  HAL_GPIO_Init(DOUT_4_GPIO_Port, &GPIO_InitStruct);
